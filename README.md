...
| 2     | If you want to extend/modify this widget library and use it in your application     |  [Click here](#Instructions-to-extend/modify-the-react-widget-library-and-use-it-in-your-react-app) |
...
2. After creating a react app, you need to install the react library package into your project. Run the below command to do the same.
	...
	``` 
3. Replace the code in App.tsx file in your react app project with the below block of code.
	```
...
### Instructions to extend/modify the react widget library and use it in your react app
